...
static gboolean button_press_callback( GtkWidget *widget, GdkEventKey *event, gpointer data )
{
...
char* list_midi_interfaces(char* midi_dev)
{
    register int  err;
...
int main( int argc, char *argv[] )
{
    ...
    list_midi_interfaces(midi_device);
...
// Open input MIDI device hw:0,0,0
    if ((err = snd_rawmidi_open(&midiInHandle, 0, "hw:1,0", 0)) < 0)
    {
